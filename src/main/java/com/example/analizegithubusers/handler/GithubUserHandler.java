...
import com.example.analizegithubusers.exception.ExceptionTransformer;
...
public class GithubUserHandler {
    ...
    public Mono<ServerResponse> findByUsernamePartiallyMatching(ServerRequest request) {
        ...
        Flux<GithubUserResponseDto> allUsersMatching = githubUserService.findByUsernamePartiallyMatching(login);
